 ...
 * how to create list items for each row of Job data in the {@link Cursor}.
 */
class JobEstimatorCursorAdapter extends CursorAdapter {
    ...
    /**
     * This method binds the Job data (in the current row pointed to by cursor) to the given
     * list item layout. For example, the name for the current Job can be set on the name TextView
